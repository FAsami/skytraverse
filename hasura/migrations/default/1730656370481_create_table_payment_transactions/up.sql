CREATE TABLE "payment"."transactions" ("id" serial NOT NULL, "userId" uuid NOT NULL, "amount" integer NOT NULL, "status" text NOT NULL, "providerId" text NOT NULL, "created_at" timestamptz NOT NULL DEFAULT now(), "updated_at" timestamptz NOT NULL DEFAULT now(), PRIMARY KEY ("id") );
