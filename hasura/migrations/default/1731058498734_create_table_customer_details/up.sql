CREATE TABLE "customer"."details" ("id" serial NOT NULL, "avatar" text, "dateOfBirth" date, "firstName" text, "lastName" text, "gender" text, "userId" uuid, "created_at" timestamptz NOT NULL DEFAULT now(), "updated_at" timestamptz NOT NULL DEFAULT now(), PRIMARY KEY ("id") );
